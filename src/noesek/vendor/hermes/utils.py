...
def atomic_replace(tmp_path: Union[str, Path], target: Union[str, Path]) -> str:
    ...
    try:
        ...
        if contended:
            ...
            from noesek.vendor.hermes.agent.retry_utils import jittered_backoff
...
def atomic_roundtrip_yaml_update(path: Union[str, Path], key_path: str, value: Any) -> None:
    ...
    # See #91607.
    from noesek.vendor.hermes.hermes_cli.config import _greedy_literal_match, _split_key_path
...
def atomic_roundtrip_yaml_save(path: Union[str, Path], new_state: dict) -> None:
    ...
    from noesek.vendor.hermes.hermes_cli.config import require_readable_config_before_write
