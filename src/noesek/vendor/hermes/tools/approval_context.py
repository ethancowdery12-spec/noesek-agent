...
# Upstream path: tools/approval_context.py
...
def _fire_approval_hook(hook_name: str, **kwargs) -> None:
    ...
    """
    try:
        from noesek.vendor.hermes.hermes_cli.lifecycle import invoke_hook
    except Exception:
...
def _resolve_cli_approval_callback(approval_callback=None):
    ...
    try:
        from noesek.vendor.hermes.tools.terminal_tool import _get_approval_callback
...
def _get_approval_mode() -> str:
    ...
    try:
        from noesek.vendor.hermes.gateway.hosted_room_execution_policy import current_room_execution_policy
...
def _get_approval_timeout() -> int:
    ...
    try:
        ...
        return 300
    try:
        from noesek.vendor.hermes.agent.deadline import MAX_SAFE_TIMEOUT_S
