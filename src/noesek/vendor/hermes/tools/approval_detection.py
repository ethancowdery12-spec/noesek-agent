...
# Upstream path: tools/approval_detection.py
...
def _normalize_command_for_detection(command: str) -> str:
    ...
    from noesek.vendor.hermes.tools.ansi_strip import strip_ansi
...
def _is_shell_token_spliced_gateway_lifecycle(command: str) -> bool:
    ...
    """
    try:
        from noesek.vendor.hermes.cron.lifecycle_guard import contains_gateway_lifecycle_command
    except Exception:
        return False
