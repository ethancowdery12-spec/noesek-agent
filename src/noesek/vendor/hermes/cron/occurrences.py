...
# Upstream path: cron/occurrences.py
...
def completed_occurrence(job, instant):
    ...
    from noesek.vendor.hermes.cron.executions import _transaction
    from noesek.vendor.hermes.cron.jobs import FIRE_CLAIM_SKEW_SECONDS
...
def pending_slot_stamp(next_run, now):
    ...
    from noesek.vendor.hermes.cron.jobs import _machine_id
...
def unclaimed_pending_slot(job, now):
    ...
    from noesek.vendor.hermes.cron.jobs import (
