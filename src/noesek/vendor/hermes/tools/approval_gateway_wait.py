...
# Upstream path: tools/approval_gateway_wait.py
...
from noesek.vendor.hermes.tools.interrupt import get_interrupt_reason, is_interrupted
from noesek.vendor.hermes.tools import approval_context as _ctx
...
def _await_gateway_decision(session_key: str, notify_cb, approval_data: dict, *, surface: str = "gateway") -> dict:
    ...
    from noesek.vendor.hermes.tools import approval as _approval
    from noesek.vendor.hermes.agent.terminal_approval_batch import approval_published, preparing_terminal_approval, register_prepared_approval
