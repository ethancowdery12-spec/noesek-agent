...
backend labels:
  vendored  - real upstream Hermes source runs the capability inside Noesek
...
def contract_report():
    return {"commit":HERMES_COMMIT,"required":sorted(CAPABILITIES),"implemented":sorted(NOESEK_IMPLEMENTED),
