...
from noesek.vendor.hermes.hermes_constants import get_config_path
...
def _env_timezone() -> str:
    ...
    from noesek.vendor.hermes.agent.secret_scope import is_multiplex_active  # lazy: secret_scope pulls in more than a clock needs
