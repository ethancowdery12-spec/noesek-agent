...
CONTROLLER_TOOLS = frozenset({
    ...
    "create_file", "speak", "optimize_prompt", "humanize", "rewrite_natural", "scrub", "generate_variants", "code_graph", "office_doc", "linkedin", "design_system", "adversarial_review", "security_audit",
})
