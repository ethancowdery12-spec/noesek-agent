...
# Upstream path: tools/skills_tool_setup.py
...
from noesek.vendor.hermes.utils import env_var_enabled
...
def _capture_required_environment_variables(
    ...
    if _is_gateway_surface() and not env_var_enabled("HERMES_INTERACTIVE"):
        try:
            from noesek.vendor.hermes.gateway.platforms.base import GATEWAY_SECRET_CAPTURE_UNSUPPORTED_MESSAGE as hint
        except Exception:
