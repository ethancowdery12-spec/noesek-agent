...
CONTROLLER_TOOLS = frozenset({
    "remember", "recall", "forget", "supersede_memory", "handoff", "switch_model", "library_docs", "search_tools",
    "create_task", "list_tasks", "cancel_task",
    "delegate_task",
    "gmail_read", "gmail_send", "calendar_read", "github_notifications",
    "create_file", "speak", "optimize_prompt", "humanize", "rewrite_natural", "scrub", "generate_variants", "code_graph", "office_doc", "linkedin", "design_system", "playbook", "browser_cookies", "adversarial_review", "security_audit",
})
