...
# Upstream path: tools/skill_ledger.py
...
def derive_actor() -> str:
    ...
    with suppress(Exception):
        from noesek.vendor.hermes.tools.skill_provenance import is_background_review
...
def ledger_enabled() -> bool:
    ...
    try:
        from noesek.vendor.hermes.hermes_cli.config import cfg_get, load_config
